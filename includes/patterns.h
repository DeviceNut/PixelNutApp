//*********************************************************************************************
// Extended Patterns for the PixelNutLib Library.
//*********************************************************************************************
/*
...
*/
#if CUSTOM_PATTERNS && !PATTERN_OVERRIDE

// extended plugins
#if !defined(PLUGIN_PLASMA)
#define PLUGIN_PLASMA 0
#endif
...
#if PLUGIN_PLASMA
// Creates a "plasma" type of effect by using Lissajious curve mathematics. Increase the Count Property for faster motion.
// Triggering changes the count, with larger Forces creating faster motion.
...
static PROGMEM const char pattern_plasma[] = "E80 Q4 T E120 F100 I T G";
#endif
...
static PROGMEM const char pattern_spectrum[] = "E0 B60 H250 W50 T E70 V1 T G";
#endif

#if PATTERN_JULY4
#define JULY4_NAME "July 4th"
#define JULY4_DESC "Celebrate the holiday with Red, White, and Blue twinkles!"
static PROGMEM const char pattern_july4[] = JK(0,33) "E50 H355 D10 T G " JK(33,34) "E50 W100 D10 T G " JK(67,34) "E50 H230 D10 T G";
#endif

#if EXTERNAL_COMM // define descriptions sent to clients

const char* const customPnames[] =
{
  #if PLUGIN_PLASMA
  PLASMA_NAME,
  #endif
...
#else // internal patterns only 
// NOTE: these are designed for (STRLEN_PATTERNS = 100) and (DELAY_RANGE = 60)
...
#endif // CUSTOM_PATTERNS && !PATTERN_OVERRIDE
//*********************************************************************************************
